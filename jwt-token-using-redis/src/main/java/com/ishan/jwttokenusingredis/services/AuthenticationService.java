package com.ishan.jwttokenusingredis.services;

import io.jsonwebtoken.Claims;
import io.jsonwebtoken.JwtParser;
import io.jsonwebtoken.Jwts;
import com.ishan.jwttokenusingredis.models.User;
import com.ishan.jwttokenusingredis.repos.UserRepo;
...
public class AuthenticationService {
    ...
    public ResponseEntity<Boolean> login(String email, String password) {
        ...
        // register user if it is not already there
